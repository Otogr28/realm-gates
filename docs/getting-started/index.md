...
<div class="sb-banner" style="background-image:url('../assets/hero-portal.webp');background-position:center 35%">
  <div class="sb-banner__inner">
    <p class="sb-eyebrow">New here? Start at the gate</p>
...
!!! info "Before you start"
    ...
    2. Ask the **admin** for the server address and to add your exact in-game name to the whitelist.
    3. New to the modded world? The **[Concepts](../concepts.md)** page explains the realms, gates
       and powers in plain language.

<p class="sb-eyebrow">Then explore</p>
